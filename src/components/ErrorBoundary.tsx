...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    console.error('NBA Legend App Error:', error, errorInfo);
  }
        ...
        <div className="min-h-screen bg-[#050811] text-white flex items-center justify-center p-4 text-center font-sans">
          <div className="max-w-md w-full bg-slate-950 border border-slate-800 rounded-3xl p-8 space-y-5 shadow-2xl">
            ...
            <div className="space-y-2">
              <h2 className="font-display font-black text-2xl uppercase">¡ACTUALIZACIÓN EN VIVO DETECTADA!</h2>
              <p className="text-xs text-slate-400 leading-relaxed">
                El simulador se ha actualizado con nuevas funciones. Haz clic abajo para refrescar tu sesión limpia.
              </p>
            </div>
            ...
            >
              ...
              <span>REINICIAR Y CARGAR VERSIÓN NUEVA</span>
            </button>
          </div>
        </div>
      );
